...
class KP {
    ...
    public function AmbilDataKP() {
        ...
        tb_mahasiswa.NIM as NIM, Nama_Mahasiswa, Nama_Dosen, Nama_Perusahaan, Kelas from tb_pendaftaran_kp 
        ...
        left join tb_dosen on tb_pendaftaran_kp.Dosen_Id = tb_dosen.Id order by Id asc";
